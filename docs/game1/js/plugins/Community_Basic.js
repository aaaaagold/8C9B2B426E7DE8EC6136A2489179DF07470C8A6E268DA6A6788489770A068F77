 ...
 * @default SceneManager._defaultWidth
 *
 * @param screenHeight
 * @desc For setting the screen height.
 * @default SceneManager._defaultHeight
 *
...
(function() {
    ...
    var screenWidth = toNumber(parameters['screenWidth'], SceneManager._defaultWidth);
    var screenHeight = toNumber(parameters['screenHeight'], SceneManager._defaultHeight);
    ...
    SceneManager._boxWidth = screenWidth; // no use?
    SceneManager._boxHeight = screenHeight; // no use?
