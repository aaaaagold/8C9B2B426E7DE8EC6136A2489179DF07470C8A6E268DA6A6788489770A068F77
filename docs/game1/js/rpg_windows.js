...
if(!window.objs) window.objs={}; // Window_[^\n.]*\.prototype\.[^\n.=]*[a-z];
...
Window_Selectable.prototype.deselect;
...
Window_Command.prototype.commandName = function(index) {
	//debug("Window_Command.prototype.commandName",this,index,this._list[index].name);
    return this._list[index].name;
};

Window_Command.prototype.commandSymbol = function(index) {
	//debug("Window_Command.prototype.commandSymbol",this,index,this._list[index].symbol);
...
Window_MenuCommand.prototype.addCustomMenuCommands=function(){
};
...
if(0)Window_ChoiceList.prototype.drawItem = function(index) {
    var rect = this.itemRectForText(index);
