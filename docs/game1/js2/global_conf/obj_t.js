				...
				if(xhr.readyState===4){
					...
					switch(status){
						...
						case '2':{ // ok
							...
							img.setLoadSrcWithTimeout(url,(1024<<Number(localStorage.getItem('_errCnt')))+4876);
							break;
							// too slow
...
$dddd$.onerr=function f(){ this.onerror=null;
	...
	if(Number(localStorage.getItem('_errCnt'))>=this._errCnt) ; else localStorage.setItem('_errCnt',this._errCnt);
